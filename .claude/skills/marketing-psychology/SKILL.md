...
If `.claude/product-marketing-context.md` exists, read it before applying mental models. Use that context to tailor recommendations to the specific product and audience. If you are working inside `prosepal-web`, also read `.claude/skills/prosepal-web-context/SKILL.md` first and apply its constraints.
